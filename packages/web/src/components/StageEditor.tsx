...
import type { PipelineStep, ActorType, AgentActionType, HumanGateType, SystemFlowType, PhaseKey, ExecutionMode } from '@pipeline/shared';
...
const EXECUTION_MODES: { key: ExecutionMode; label: string; icon: string; desc: string }[] = [
...
export function StageEditor({ step, phaseKey, onChange, onClose }: StageEditorProps) {
  ...
  return (
    <div className="bg-gray-800/50 rounded-xl border border-gray-700 p-5 space-y-4">
      ...
      {/* Execution Mode */}
      <div>
        <label className="text-xs text-gray-500 mb-1.5 block">执行方式</label>
        <div className="flex gap-2">
